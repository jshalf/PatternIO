...
purpose: This is a base class I/O benchmark for all interleaved
    ...
    2) WriteIntereaved(): This writes the interleaved pattern in parallel to disk.
...
Those are pretty much the only steps these classes virtualize.  There are internal helper functions,
